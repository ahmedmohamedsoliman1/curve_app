           ...
           Scaffold(
              body: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      SizedBox(height: heightMediaQuery(height: 0.07, context: context),),
                      Row(
                      ...
                      Image(image: const AssetImage("assets/images/logo.png") ,
                        ...
                        height: heightMediaQuery(height: 0.2, context: context),),
                      const Text(AppStrings.createnewAccount , style: TextStyle(
                          color: AppColors.blackColor , fontWeight: FontWeight.bold ,
                          fontFamily: AppStrings.fontFamilyBold ,
                          fontSize: 17
                      ),),

                      SizedBox(height: heightMediaQuery(height: 0.05, context: context),),
                      Stack(
                        children: [
                          Expanded(
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          const Text(AppStrings.agreeSH , style: TextStyle(
                          ...
                          GetBuilder(
                              ...
                              builder: (controller){
                                return Checkbox(
                                    ...
                                    onChanged: controller.changeCheckBoxValue);
                              }),
                        ],
                      ) ,
                      SizedBox(
